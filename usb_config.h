...
/** DEVICE CLASS USAGE *********************************************/
#define USB_USE_VIDEO_CLASS

#define VIDEO_CONTROL_INTERFACE_ID 0x00
#define VIDEO_STREAMING_INTERFACE_ID 0x01
...
#define USB_VIDEO_ENDPOINT_CONTROL_REQUESTS_HANDLER UsbAudioEndpointControlRequestsHandler
